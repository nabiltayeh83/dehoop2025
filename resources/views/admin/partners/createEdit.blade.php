        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    @if(isset($data->item))
                    {!! Form::model($data->item, ['route' => ['admin.Partner.update', $data->item->id], 'method' => 'post','files' => true]) !!}
                    {{ method_field('PATCH')}}
                    @else
                        ...
                        <div class="form-group col-sm-12 row">
                            @foreach($locales as $locale)
                               <div class="form-group col-sm-6">
                                    ...
                                    {!! Form::text('title_'.$locale->code, old('title_'.$locale->code, isset($data->item)?$data->item->translate($locale->code)->title:'' ), ['class' => 'form-control', 'required' => 'required' ]) !!}
                                </div>
                            @endforeach 
                        </div>
                    ...
                    <div class="form-group col-sm-12 row" style="background-color: #ccc; padding:10px; margin-bottom: 5px;">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <a href="{{ route('admin.Partner.index') }}" class="btn btn-warning">{{ __('translate.cancel') }}</a>
                        </div>
