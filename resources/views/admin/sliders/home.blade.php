                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            @if(has_permission('admin.Slider.create') == true)
                                <a href="{{ route('admin.Slider.create') }}" style="margin-right: 5px" class="btn btn-primary">
                                    {{ __('translate.add') }}
                            ...
                            @if(has_permission('admin.Slider.edit') == true)
                            ...
                            @if(has_permission('admin.Slider.destroy') == true)
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                @if(has_permission('admin.Slider.show') == true)
                                    <a href="{{ route('admin.Slider.show', $one->id) }}" class="btn btn-xs tooltips" data-container="body" data-placement="top" data-original-title="{{__('translate.view')}}">
                                ...
                                @if(has_permission('admin.Slider.edit') == true)
                                    <a href="{{ route('admin.Slider.edit', $one->id) }}" class="btn btn-xs tooltips" data-container="body" data-placement="top" data-original-title="{{__('translate.edit')}}">
                                        <i class="fa fa-edit text-primary fs-2"></i>
                                    </a>
                                @endif
        

                                @if(has_permission('admin.Slider.destory') == true)
