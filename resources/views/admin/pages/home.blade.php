                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            @if(has_permission('admin.Page.create') == true)
                                <a href="{{ route('admin.Page.create') }}" style="margin-right: 5px" class="btn btn-primary">
                                    {{ __('translate.add') }}
                            ...
                            <!--@if(has_permission('admin.Page.edit') == true)-->
                            ...
                            <!--@if(has_permission('admin.Page.destroy') == true)-->
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="p-0">
                            <div class="btn-group btn-action">
                                @if(has_permission('admin.Page.show') == true)
                                    <a href="{{ route('admin.Page.show', $one->id) }}" class="btn btn-xs tooltips" data-container="body" data-placement="top" data-original-title="{{__('translate.view')}}">
                                ...
                                @if(has_permission('admin.Page.edit') == true)
                                    <a href="{{ route('admin.Page.edit', $one->id) }}" class="btn btn-xs tooltips" data-container="body" data-placement="top" data-original-title="{{__('translate.edit')}}">
                                        <i class="fa fa-edit text-primary fs-2"></i>
                                    </a>
                                @endif
        

                                <!--@if(has_permission('admin.Page.destory') == true)-->
