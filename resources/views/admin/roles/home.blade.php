                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            @if(has_permission('admin.Role.create') == true)
                                <a href="{{ route('admin.Role.create') }}" style="margin-right: 5px" class="btn btn-primary">
                                    {{ __('translate.add') }}
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @forelse($data->items as $one)
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        @if(has_permission('admin.Role.edit') == true)
                        <a href="{{ route('admin.Role.edit', $one->id) }}" class="btn btn-xs tooltips"
                           data-container="body" data-placement="top" data-original-title="{{__('translate.edit')}}">
                            <i class="fa fa-edit text-primary fs-2"></i>
                        </a>
                        @endif
        

                        @if(has_permission('admin.Role.destory') == true)
                        <a data-id="{{$one->id}}" data-toggle="tooltip" data-container="body" data-placement="top"
                           data-original-title="{{__('translate.delete')}}"
